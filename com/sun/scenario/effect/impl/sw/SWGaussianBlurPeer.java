...
public class SWGaussianBlurPeer extends SWEffectPeer {
   private FloatBuffer kvals;

   public SWGaussianBlurPeer(GraphicsConfiguration gc) {
      super(gc);
   }

   protected final GaussianBlur getEffect() {
      return (GaussianBlur)super.getEffect();
   }
